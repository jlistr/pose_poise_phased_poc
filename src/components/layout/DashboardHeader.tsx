...
export function DashboardHeader({
  ...
  const tierInfo = {
    ...
    PROFESSIONAL: {
      label: "Pro",
      className: styles.tierBadgePro,
      icon: <CrownIcon />,
    },
    DELUXE: {
      label: "Deluxe",
      className: styles.tierBadgeDeluxe,
      icon: <SparkleIcon />,
    },
  };
  const currentTier =
        ...
        <div className={styles.headerRight}>
          ...
          <div className={styles.userMenu}>
            ...
            >
              ...
              {subscriptionTier && subscriptionTier !== "FREE" && (
                <span
                  className={`${styles.headerTierBadge} ${currentTier.className}`}
                >
                  {currentTier.icon}
                  {currentTier.label}
                </span>
              ...
              <>
                ...
                <div className={styles.dropdown}>
                  <div className={styles.dropdownHeader}>
                    ...
                    <span
                      className={`${styles.tierBadge} ${currentTier.className}`}
                    >
                      {currentTier.icon}
