    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          border: `1px solid ${showCelebration ? "var(--color-brand-gold)" : colors.border}`,
          display: "flex",
          alignItems: "center",
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          <span style={{ fontSize: "14px", color: colors.textPrimary }}>
            <strong
              className={`progress-count ${showCelebration ? "celebrating" : ""}`}
            >
              {displayCount}
            </strong>{" "}
            field{collectedCount !== 1 ? "s" : ""} collected
          </span>
        </div>
        <span
