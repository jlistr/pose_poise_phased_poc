...
export const DEFAULT_SERVICE_CATEGORIES: ServiceCategory[] = [
  {
    id: "fashion",
    name: "Fashion",
    description: "Runway, editorial, commercial fashion",
    selected: false,
  },
  {
    id: "commercial",
    name: "Commercial",
    description: "Advertising, product, lifestyle",
    selected: false,
  },
  {
    id: "editorial",
    name: "Editorial",
    description: "Magazine, artistic, conceptual",
    selected: false,
  },
  {
    id: "fitness",
    name: "Fitness",
    description: "Athletic wear, sports, wellness",
    selected: false,
  },
  {
    id: "glamour",
    name: "Glamour",
    description: "Beauty, swimwear, lingerie",
    selected: false,
  },
  {
    id: "portrait",
    name: "Portrait",
    description: "Headshots, personal branding",
    selected: false,
  },
];
