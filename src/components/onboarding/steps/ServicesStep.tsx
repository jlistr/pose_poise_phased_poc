...
const EXPERIENCE_LEVELS: {
...
}[] = [
  {
    id: "beginner",
    label: "Beginner",
    description: "New to modeling, building portfolio",
  },
  {
    id: "intermediate",
    label: "Intermediate",
  ...
  },
  {
    id: "professional",
    label: "Professional",
    description: "3+ years, established career",
  },
  {
    id: "expert",
    label: "Expert",
    description: "Top-tier, international work",
  },
];
...
export function ServicesStep({
  data,
  onChange,
}: ServicesStepProps): React.JSX.Element {
  ...
  return (
    <>
      ...
      >
        Tell us what you offer. This helps clients find the right model for
        their projects.
      </p>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        >
          ...
          {isSuggesting
            ...
            : "Suggest services based on my profile"}
        </button>
      </div>
              ...
              style={{
                ...
                backgroundColor:
                  data.experienceLevel === level.id
                    ...
                    : colors.white,
                border: `1px solid ${data.experienceLevel === level.id ? "var(--color-brand-gold)" : colors.border}`,
                borderRadius: "0.5rem",
                cursor: "pointer",
                transition: "all 0.2s",
              }}
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: category.selected
                  ? "var(--color-brand-light)"
                  : colors.white,
                border: `1px solid ${category.selected ? "var(--color-brand-gold)" : colors.border}`,
                borderRadius: "0.5rem",
                cursor: "pointer",
                transition: "all 0.2s",
              }}
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              height: "28px",
              borderRadius: "14px",
              backgroundColor: data.travelAvailable
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              height: "28px",
              borderRadius: "14px",
              backgroundColor: data.tfpAvailable
                ? "var(--color-brand-gold)"
                : colors.border,
              border: "none",
              cursor: "pointer",
