...
import { colors, fonts, TEMPLATES, type Template } from "../types";
...
const _LockIcon: React.FC<{ size?: number }> = ({ size = 12 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    >
      ...
      <div
        style={{
          ...
          alignItems: "center",
          padding: "8px 12px",
          borderBottom: `1px solid ${template.textColor}10`,
        }}
      >
        <div
          style={{
    ...
    >
      ...
      <div
        style={{
          height: "45%",
          position: "relative",
          background: `linear-gradient(180deg, ${template.bgColor} 0%, rgba(44, 36, 32, 0.8) 100%)`,
        }}
      >
          ...
          {[0.9, 1, 0.85].map((scale, i) => (
            ...
            >
              <div
                style={{
                  aspectRatio: "3/4",
                  background: `linear-gradient(135deg, ${terracotta}30 0%, rgba(26, 26, 26, 0.1) 100%)`,
                  borderRadius: "1px",
                }}
              />
            </div>
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            backgroundColor: terracotta,
            boxShadow: `0 0 6px ${terracotta}60`,
          }}
        />
      </div>
    </div>
...
function TemplatePreview({
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: isSelected
          ? `0 8px 24px rgba(196, 164, 132, 0.25), 0 0 0 1px var(--color-brand-gold)`
    ...
    >
      ...
      <div style={{ height: "220px", width: "100%" }}>{renderPreview()}</div>
      ...
      >
        ...
        >
          ...
          >
            {template.galleryStyle === "masonry"
              ? "MASONRY"
              : template.galleryStyle === "grid-3"
                ? "3-COL"
                : template.galleryStyle === "grid-2"
                  ? "2-COL"
                  : "FILM"}
          </div>
        </div>
        <div
          style={{ fontSize: "12px", color: colors.textMuted, lineHeight: 1.4 }}
        >
...
export function TemplateStep({
  ...
  onSelectTemplate,
  modelName = "",
}: TemplateStepProps): React.JSX.Element {
  return (
    <>
      {/* Header */}
      <h1
      ...
      >
        Each template offers a unique layout and gallery style. Pick one that
        showcases your work best.
      </p>
      <p
        style={{
          fontSize: "12px",
