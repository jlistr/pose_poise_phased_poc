...
function LocationDetection({
  status,
  location,
}: LocationDetectionProps): React.JSX.Element {
  return (
    <div
      style={{
        marginBottom: "2rem",
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            backgroundColor:
              status === "found" ? colors.successLight : "#FFF8E7",
            display: "flex",
            alignItems: "center",
        ...
        <div style={{ flex: 1 }}>
          ...
          {status === "found" && (
            <>
              ...
              >
                This helps us suggest appropriate services and connect you with
                local markets
              </p>
            </>
          )}
...
export function ProfileStep({
  ...
  useEffect(() => {
    ...
    detectLocation();
  }, [initialLocation, data, onChange]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <>
      ...
      >
        Let's establish your professional identity. We'll auto-detect what we
        can.
      </p>
      ...
      >
        ...
        <div>
          ...
          {validationErrors.username ? (
            ...
            >
              Your portfolio will be at {data.username || "yourname"}
              .poseandpoise.studio
            </p>
          )}
        </div>
